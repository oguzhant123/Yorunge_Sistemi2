...
namespace SimpleKeplerOrbits
{
	...
	public class KeplerOrbitMover : MonoBehaviour
	{
		...
		/// </summary>
		[Range(0f, 100f)]   //HIZ KOLU AYARI 0-100f ARASINDA
		...
		/// </summary>
		[Tooltip("The time scale multiplier.")] // ZAMAN ÖLÇEİ - DÖNÜŞ HIZINI BELİRLİYOR
			...
			if (IsReferencesAsigned)
			{
				if (!LockOrbitEditing)
				{
					...
					if ((Vector3)position != (Vector3)OrbitData.Position ||
						...
						OrbitData.AttractorMass != AttractorSettings.AttractorMass)     // POZİSYON MASS VEYA YÖRÜNGE PARAMETRESİ 
					{                                                                   // DEĞİŞTİRİLİRSE                                                                                                      
                            ForceUpdateOrbitData();                        
					}
				}
